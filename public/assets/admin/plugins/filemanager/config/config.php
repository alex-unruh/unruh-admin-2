...
$config = array(
    ...
    */
    ...
    |
    */
	'upload_dir' => '/assets/admin/uploads/source/',
	/*
    |--------------------------------------------------------------------------
    ...
    */
	...
	'fixed_path_from_filemanager'             => array('../../uploads/medium/', '../../uploads/large/'), //fixed path of the image folder from the current position on upload folder
	...
	'fixed_image_creation_width'              => array(400, 800), //width of image
	'fixed_image_creation_height'             => array(0, 0), //height of image
	/*
    #             $option:     0 / exact = defined size;
    #                          1 / portrait = keep aspect set height;
    #                          2 / landscape = keep aspect set width;
    ...
    #                          4 / crop= resize and crop;
    */
	'fixed_image_creation_option'             => array('landscape', 'landscape', 'landscape'), //set the type of the crop
	...
	'relative_image_creation_height'          => array('', ''), //height of image
	/*
     * $option:     0 / exact = defined size;
     *              1 / portrait = keep aspect set height;
     *              2 / landscape = keep aspect set width;
